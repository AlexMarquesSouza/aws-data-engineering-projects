# Qualidade de dados com DQDL

> AWS 009 · intermediário · AWS Glue Data Quality

Avalia completude, unicidade e valor positivo, acompanhada de um ruleset DQDL realista.

![Arquitetura](docs/arquitetura.svg)

```bash
python3 -m src.quality
...
| Item | Função |
|---|---|
| Python/CSV | Execução local equivalente |
| Glue Data Quality | Avaliação gerenciada futura |
| DQDL | Qualidade como código |
| IsComplete/IsUnique/ColumnValues | Regras do domínio |
| Data quality score | Percentual de regras aprovadas |

Python 3.10+ e custo local zero; Glue pode gerar custos. Validado score de 25%, com duplicidade, campo vazio e valor zero detectados.

## Tecnologias relacionadas ainda não utilizadas
Sem Glue Catalog, ETL Job, row-level results, CloudWatch, anomalias ou deploy.

## Referências oficiais
- [AWS Glue Data Quality](https://docs.aws.amazon.com/glue/latest/dg/glue-data-quality.html)
- [Referência DQDL](https://docs.aws.amazon.com/glue/latest/dg/dqdl.html)
...
cd "009-glue-data-quality-dqdl"
```

Confirme que `pwd` termina em `009-glue-data-quality-dqdl`. Os caminhos relativos usados pelo código dependem disso.
