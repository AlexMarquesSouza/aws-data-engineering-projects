...
1. Abra [Settings → Pages](https://github.com/AlexMarquesSouza/aws-data-engineering-projects/settings/pages).
...
```text
https://alexmarquessouza.github.io/aws-data-engineering-projects/
```
