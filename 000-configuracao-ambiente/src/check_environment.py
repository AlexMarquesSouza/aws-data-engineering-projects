...
def inspect_environment():
    tools={name:shutil.which(name) for name in ("python3","code","git","aws")}; return {"python":platform.python_version(),"python_supported":sys.version_info>=(3,10),"tools":tools,"required_ready":bool(tools["python3"]),"optional_cloud_ready":bool(tools["aws"])}
def main():
